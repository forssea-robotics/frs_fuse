...
public:
  ...
  explicit Base(NodeT& node)
  {
    impl_ = node.get_node_base_interface();
  }
  ...
  inline void set_node_base_interface(rclcpp::node_interfaces::NodeBaseInterface::SharedPtr interface)
  {
    impl_ = interface;
  }
...
public:
  ...
  template <class NodeT>
  explicit Clock(NodeT& node)
  {
    impl_ = node.get_node_clock_interface();
  }
  ...
  inline void set_node_clock_interface(rclcpp::node_interfaces::NodeClockInterface::SharedPtr interface)
  {
    impl_ = interface;
  }
...
public:
  ...
  template <class NodeT>
  explicit Graph(NodeT& node)
  {
    impl_ = node.get_node_graph_interface();
  }
  ...
  inline void set_node_graph_interface(rclcpp::node_interfaces::NodeGraphInterface::SharedPtr interface)
  {
    impl_ = interface;
  }
...
public:
  ...
  template <class NodeT>
  explicit Logging(NodeT& node)
  {
    impl_ = node.get_node_logging_interface();
  }
  ...
  inline void set_node_logging_interface(rclcpp::node_interfaces::NodeLoggingInterface::SharedPtr interface)
  {
    impl_ = interface;
  }
...
public:
  ...
  template <class NodeT>
  explicit Parameters(NodeT& node)
  {
    impl_ = node.get_node_parameters_interface();
  }
  ...
  inline void set_node_parameters_interface(rclcpp::node_interfaces::NodeParametersInterface::SharedPtr interface)
  {
    impl_ = interface;
  }
...
public:
  ...
  template <class NodeT>
  explicit Services(NodeT& node)
  {
    impl_ = node.get_node_services_interface();
  }
  ...
  inline void set_node_services_interface(rclcpp::node_interfaces::NodeServicesInterface::SharedPtr interface)
  {
    impl_ = interface;
  }
...
public:
  ...
  template <class NodeT>
  explicit TimeSource(NodeT& node)
  {
    impl_ = node.get_node_time_source_interface();
  }
  ...
  inline void set_node_time_source_interface(rclcpp::node_interfaces::NodeTimeSourceInterface::SharedPtr interface)
  {
    impl_ = interface;
  }
...
public:
  ...
  template <class NodeT>
  explicit Timers(NodeT& node)
  {
    impl_ = node.get_node_timers_interface();
  }
  ...
  inline void set_node_timers_interface(rclcpp::node_interfaces::NodeTimersInterface::SharedPtr interface)
  {
    impl_ = interface;
  }
...
public:
  ...
  template <class NodeT>
  explicit Topics(NodeT& node)
  {
    impl_ = node.get_node_topics_interface();
  }
  ...
  inline void set_node_topics_interface(rclcpp::node_interfaces::NodeTopicsInterface::SharedPtr interface)
  {
    impl_ = interface;
  }
...
public:
  ...
  template <class NodeT>
  explicit Waitables(NodeT& node)
  {
    impl_ = node.get_node_waitables_interface();
  }
  ...
  inline void set_node_waitables_interface(rclcpp::node_interfaces::NodeWaitablesInterface::SharedPtr interface)
  {
    impl_ = interface;
  }
